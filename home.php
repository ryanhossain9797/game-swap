...
<div class="container" id="posts">
    <form class="form-control searchform" action="search.php" method="post" id="post">
        <div class="form-group mx-sm-3 mb-2">
            <input type="text" class="form-control" name="search" id="searchterm" placeholder="Search">
        </div>
    </form>
    <?php
